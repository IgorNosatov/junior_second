<?php  //[STAMP] dbbd55d31490733bcde622c8d8eaadda
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::setMockWebServer()
     */
    public function setMockWebServer() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setMockWebServer', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::stopMockWebServer()
     */
    public function stopMockWebServer() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('stopMockWebServer', func_get_args()));
    }
}
